...
public class TitleMatchContent extends Metric{
   ...
   public String returnResults() {
      String output ="<li><h3>Title Relevance</h3>";
      output += "<table border=\"1\"><tr><th>Site</th><th>Title Relevant?</th></tr>";
   ...
   public String returnRecommendations() {
      ...
      if(0 == results[0]) {
         output += "<p><b>Make the page title more relevant to the page content.</b></p>";
      } else if (-1 == results[0]){
         output += "<p><b>Add a title to the page.</b></p>";
      }else{
